...
To balance the need for anonymity with democratic decision making, we employ a novel approach: proof of personhood checks. Upon joining, members undergo a verification process that ensures each person has only one account, while also maintaining their anonymity. [Learn more](https://zk.me/did-solution).
